...
{
	public static NewCycle Handler { get; private set; }
	...
	/// </summary>
	List<MeshRenderer> AnimatedSprites, StaticSprites;
	...
	void UpdateAnimated()
	{
		for (int i = 0; i < AnimatedSprites.Count; i++)
		{
			...
			{
				AnimatedSprites[i].material.color = mainColor;
			}
		}
	}
	...
	void UpdateStatic()
	{
		if (colored)
		{
			for (int i = 0; i < StaticSprites.Count; i++)
			{
				...
				{
					StaticSprites[i].material.color= mainColor;
				}
			}
	...
	public void RegRenderer(MeshRenderer render, bool animated)
	{
		if (animated)
		{
	...
	public void DelRenderer(MeshRenderer render, bool animated)
	{
		if (animated)
		{
