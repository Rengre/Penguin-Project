...
public class NewRegister : MonoBehaviour
{
	...
	/// </summary>
	private MeshRenderer spriteRend; //------------} These are the variables you would set to 
	...
	void OnDestroy()
	{
		...
		if (spriteRend != null)
		{
			//NewCycle.Handler.DelRenderer(spriteRend, animated);
		}
		if (miscRend != null)
		{
			NewCycle.Handler.DelRenderer(miscRend);
		}
